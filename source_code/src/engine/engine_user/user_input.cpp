...
UserInput::UserInput(GLFWwindow* setWindow)
{
    window = setWindow;
};

int UserInput::inputKeyboard()
{
    ...
    if(glfwGetKey(this->window, GLFW_KEY_F5 == GLFW_PRESS))
        return 106;
    if(glfwGetKey(this->window, GLFW_KEY_F6 == GLFW_PRESS))
        return 107;
    if(glfwGetKey(this->window, GLFW_KEY_F7 == GLFW_PRESS))
        return 108;
    if(glfwGetKey(this->window, GLFW_KEY_F8 == GLFW_PRESS))
        return 109;
    if(glfwGetKey(this->window, GLFW_KEY_F9 == GLFW_PRESS))
        return 110;
    if(glfwGetKey(this->window, GLFW_KEY_F10 == GLFW_PRESS))
        return 111;
    if(glfwGetKey(this->window, GLFW_KEY_F11 == GLFW_PRESS))
        return 112;
    if(glfwGetKey(this->window, GLFW_KEY_F12 == GLFW_PRESS))
        return 113;
    ...
    if(glfwGetKey(this->window, GLFW_KEY_P == GLFW_PRESS))
        return 138;
    if(glfwGetKey(this->window, GLFW_KEY_LEFT_BRACKET == GLFW_PRESS))
        return 139;
    if(glfwGetKey(this->window, GLFW_KEY_RIGHT_BRACKET == GLFW_PRESS))
        return 140;
    if(glfwGetKey(this->window, GLFW_KEY_BACKSLASH == GLFW_PRESS))
        return 141;

    if(glfwGetKey(this->window, GLFW_KEY_CAPS_LOCK == GLFW_PRESS))
        return 142;
    ...
    if(glfwGetKey(this->window, GLFW_KEY_M == GLFW_PRESS))
        return 162;
    if(glfwGetKey(this->window, GLFW_KEY_COMMA == GLFW_PRESS))
        return 163;
    if(glfwGetKey(this->window, GLFW_KEY_PERIOD == GLFW_PRESS))
        return 164;
    if(glfwGetKey(this->window, GLFW_KEY_SLASH == GLFW_PRESS))
        return 165;
    if(glfwGetKey(this->window, GLFW_KEY_RIGHT_SHIFT == GLFW_PRESS))
        return 166;
    ...
    if (glfwGetKey(window, GLFW_KEY_SPACE) == GLFW_PRESS)
        return 169;
    if(glfwGetKey(this->window, GLFW_KEY_RIGHT_ALT == GLFW_PRESS))
        return 170;
